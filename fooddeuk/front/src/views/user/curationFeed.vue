    ...
    <div class="wrapC">
        <div class="wrapper">
            <div class="header" style="width:100%; height:40px">
                ...
                <p style="vertical-align: middle;padding: 8px 5px;float:left;">나의 큐레이션 피드</p>
            </div>
                <div style="position:absolute; margin-left:30px; top:40%; text-align:center; font-size:25px;" v-if="this.nothing === true ">
                    선택된 지역정보가 없습니다. <br>
                    지역정보를 설정해주세요.
                </div>
                <div v-else-if="!post" style="margin-top:50px; text-align:center"> 게시물이 없습니다.</div>
