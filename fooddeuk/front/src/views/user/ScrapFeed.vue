...
<v-app data-app>
    <div class="header" style="width:100%; height:40px;">
        ...
        <p style="vertical-align: middle;padding: 8px 5px;float:left;">내가 스크랩한 피드</p>
    </div>
    <div class="wrapC">
        <div class="wrapper">
            <div v-if="!post" style="margin-top:70px; text-align:center"> 게시물이 없습니다.</div>
                ...
                <div v-if="item.type==='스크랩'">
                    ...
                    >
                    <v-list-item>
                         <v-list-item-avatar v-if="item.picture" style="height:50px; width:50px" @click="goProfileByNickname(nick)"><img :src="item.picture"></v-list-item-avatar>
                        <v-list-item-avatar v-else style="height:50px; width:50px" @click="goProfileByNickname(nick)"><img src="../../assets/images/profile_default.png"></v-list-item-avatar>
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            //포스트 불러오기
            this.getUserByNickname(this.nick);
        },
        watch : {
